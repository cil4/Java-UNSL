...
CREATE TABLE `prof_materia` (
  ...
  PRIMARY KEY (`M_Id`,`P_CUIL`),
  KEY `P_CUIL` (`P_CUIL`),
  CONSTRAINT `prof_materia_ibfk_1` FOREIGN KEY (`M_Id`) REFERENCES `materia` (`M_Id`),
  CONSTRAINT `prof_materia_ibfk_2` FOREIGN KEY (`P_CUIL`) REFERENCES `profesor` (`P_CUIL`)
...
INSERT INTO `prof_materia` VALUES (2,20334129003),(5,20334129003),(3,27347876905),(6,27347876905),(7,27409992124),(8,27409992124),(9,27899090906),(11,27903231213);
