...
public class Agregar extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         Mostrar vent = new Mostrar();
        vent.setNombre(nombre.getText());
        vent.setApellido(apellido.getText());
        vent.setCargo((String) cargo.getSelectedItem());
        if(femenino.isSelected())
            vent.setGenero(femenino.getText());
        else vent.setGenero(masculino.getText());
        vent.setDias((int) dias.getValue());
        vent.setSalario(salario.getText());
        vent.setIngresos(ingresos.getText());
        vent.setPagos(pagos.getText());
        vent.setAportes(aportes.getText());
